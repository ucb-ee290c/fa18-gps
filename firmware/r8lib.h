...
_Bool r8_is_in_01 ( double a );
_Bool r8_is_inf ( double r );
_Bool r8_is_insignificant ( double r, double s );
_Bool r8_is_integer ( double r );
_Bool r8_is_nan ( double r );
...
_Bool r8mat_is_binary ( int m, int n, double a[] );
double r8mat_is_identity ( int n, double a[] );
_Bool r8mat_is_in_01 ( int m, int n, double a[] );
_Bool r8mat_is_insignificant ( int m, int n, double r[], double s[] );
_Bool r8mat_is_integer ( int m, int n, double a[] );
_Bool r8mat_is_significant ( int m, int n, double r[], double s[] );
...
_Bool r8vec_is_ascending ( int n, double x[] );
_Bool r8vec_is_ascending_strictly ( int n, double x[] );
_Bool r8vec_is_binary ( int n, double a[] );
_Bool r8vec_is_distinct ( int n, double x[] );
_Bool r8vec_is_in_01 ( int n, double x[] );
_Bool r8vec_is_in_ab ( int n, double x[], double a, double b );
_Bool r8vec_is_insignificant ( int n, double r[], double s[] );
_Bool r8vec_is_integer ( int n, double a[] );
_Bool r8vec_is_negative ( int n, double a[] );
_Bool r8vec_is_negative_any ( int n, double a[] );
_Bool r8vec_is_nonnegative ( int n, double x[] );
_Bool r8vec_is_nonpositive ( int n, double a[] );
_Bool r8vec_is_nonzero_any ( int n, double a[] );
_Bool r8vec_is_one ( int n, double x[] );
_Bool r8vec_is_positive ( int n, double a[] );
_Bool r8vec_is_zero ( int n, double x[] );
